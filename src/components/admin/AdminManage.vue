  ...
  <div>
    <div style="margin-bottom: 5px;">
      <el-input v-model="name" placeholder="请输入名字" style="width: 200px"
                @keyup.enter.native="loadPost"  suffix-icon="el-icon-search"></el-input>
    ...
    return {
      ...
      rules: {
        ...
        phone: [
          ...
          {pattern: /^1[3|4|5|6|7|8|9][0-9]\d{8}$/, mesage:'请输入正确的手机号',trigger: 'blur'}
        ],
      }
    }
  },
